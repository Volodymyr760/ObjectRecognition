...
{
    // based on https://www.codeproject.com/Tips/240428/Work-with-Bitmaps-Faster-in-Csharp-3
    public class LockBitmap
    {
        ...
        public Bitmap Clone(Image image)
        {
            try
            {
                //RectangleF rec = new RectangleF(0,0, Width, Height);
                //var cloned = Bitmap.Clone(rec, image.PixelFormat);
                ...
                //Marshal.Copy(rgbValues, 0, Iptr, bytes);
